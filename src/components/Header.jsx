        ...
        <div className="flex justify-between py-4">
          ...
          <div className="flex justify-between w-full">
            ...
            <ul className="hidden md:ml-6 md:flex md:items-center md:space-x-4">
              <a
                href="https://independent-hcdt-monitor-c-44b7ef33175a.herokuapp.com"
            ...
            <div className="hidden md:flex md:items-center">
              <a href={`https://independent-hcdt-monitor-c-44b7ef33175a.herokuapp.com/auth/1`}>
                <button className="px-4 py-2 text-sm font-medium text-blue-2 mr-2">
                  Log In
                </button>
              </a>
              <a href={`https://independent-hcdt-monitor-c-44b7ef33175a.herokuapp.com/auth/2`}>
